...
*Detailed how-to documentation will be developed as the tool matures.*
...
For full documentation on the underlying simulation engine, visit [joshsim.org](https://joshsim.org).
